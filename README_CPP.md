...
- `src/`: Implementation of the 100MB Integral
  - `benchmark.cpp`: Scale Law verification (1MB -> 10MB -> 100MB)
...
#### Run the Hutter Benchmark
```bash
# Compile the benchmark
g++ -std=c++20 -O3 -march=native src/benchmark.cpp -o src/benchmark
