...
## 1. Slice Orientation
The Yukawa hierarchy depends on the irrational slice through E8.

Unknown: Can orientation be derived from symmetry-breaking instead of assumed?

---

## 2. Coupling Unification
Spectral Action predicts unification at warped scale.

Unknown: Is the warp factor determined uniquely by Λ?

---

## 3. Cosmological Constant
Λ interpreted as surface tension of the horizon.

Open: Does this derive from G2 torsion, or from boundary condition?

---

## 4. Neutrino Sector
Seesaw mechanism consistent, but mass ordering unresolved.

Question: Normal or inverted hierarchy?
